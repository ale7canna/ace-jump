...
namespace AceJumpPackage.Tests.Helpers
{
  ...
  public class LetterReferenceDictionaryTests
  {
    ...
    public void if_found_locations_than_Z_then_A_Z()
    {
      ...
      foreach (var keyLocation in foundKeyLocations) letterDictionary.AddSpan(keyLocation);
    ...
    {
      // one more than z
      var foundKeyLocations = CreateLocations(52);
    ...
    {
      var foundKeyLocations = new List<int>();
      for (var i = 1; i <= numberOflocations; i++) foundKeyLocations.Add(i);
